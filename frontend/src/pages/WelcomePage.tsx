      ...
      <main style={styles.main}>
        ...
        <section style={styles.section}>
          <div style={styles.contentWrapper}>
            ...
            <p style={styles.contentText}>
              Живеем в свят, пълнен с предизвикателства: мръсен въздух, постоянен стрес, лошо качество на живот и непрекъснат поток от информация. 
              Повечето хора се опитват да „избягат" от своето емоционално състояние, скролвайки безкрайно в мобилни приложения или интернет. 
            ...
            <p style={styles.contentText}>
              ...
              където можете да следите вашия прогрес и да отразявате вашите мисли и чувства. Направихме и място, в което можете да записвате целите си и да виждате как ги постигате. 
                Всичко това е създадено, за да ви помогне да изградите по-здравословни навици и да водите по-балансиран живот. Скоро очаквайте събития и групови активности в нашата Фейсбук група!
            ...
            <div style={styles.stepsContainer}>
              <div style={styles.step}>
                ...
                <h3 style={styles.stepTitle}>Попълнете въпросника</h3>
                <p style={styles.stepDescription}>Отговорете на серия от въпроси за вашето физическо и психическо здраве и спрямо него ще получите предизвикателство, което се намира под статуса Ви. Покачвате нива когато изпълнявате предизвикателствата.</p>
              </div>
              <div style={styles.step}>
                <div style={styles.stepNumber}>2</div>
                <h3 style={styles.stepTitle}>Получете предизвикателства</h3>
                <p style={styles.stepDescription}>Получавате предизвикателства въз основа на вашите отговори</p>
              </div>
              <div style={styles.step}>
                <div style={styles.stepNumber}>3</div>
                <h3 style={styles.stepTitle}>Изпълнете предизвикателствата</h3>
                <p style={styles.stepDescription}>Завършете дневните и седмичните предизвикателства, за да натрупате опит. Записвайте как се чувствате в дневника и бъдете по-организирани,като записвате целите си. </p>
              </div>
              <div style={styles.step}>
                <div style={styles.stepNumber}>4</div>
                <h3 style={styles.stepTitle}>Прогресирайте</h3>
                <p style={styles.stepDescription}>Покачвайте нива, събирайте значки, състезавайте се с други и следите вашия прогрес, като с времето предизвикателствата стават по-сложни.</p>
              </div>
            </div>
        ...
        <footer style={styles.footer}>
           <p>Сaйтът е създаден за Национална олимпиада по информационни технологии 2025/2026 година</p>
           <p>Автори: Петя Стефанова, Иван Гълабаров</p>
          <p>Създадено с ❤️ за по-добър свят</p>
        </footer>
      </main>
    </div>
  )
